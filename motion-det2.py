...
#install the any mobile application, which can provide live streaming like droidcam.
#NOTE: both the device i.e., mobile and desktop are connected with same wifi (hospot of the same mobile not allowed, from which you're performing live streaming)
src = "http://192.168.1.4:4747/video"
#start the webcam
...
def Alert(frame):
    ...
    prepare_and_send_email('tanuj2020csds026@abesit.edu.in', 'tanuj2020csds026@abesit.edu.in', 'Alert Alert Alert', 'Hi Tash Bhaii,\nMotion is detected at the premises.\n\n\n\nRegards,\nTanuj', frame)
    time.sleep(120)
    next_send_mail = True
